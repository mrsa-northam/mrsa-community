-- Backfill schedule rows for the active tournament when the initial schedule migration
-- was run before the target tournament filter matched the real event.
