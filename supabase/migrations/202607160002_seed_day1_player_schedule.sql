...
match_rows(external_match_id, time_label, start_time, court_label, pod_label, format, match_type, match_color, tier_rule, team_a_name, players_a, team_b_name, players_b, sort_order) as (
  values
    ...
    ('9', '9:30 AM', '09:30', 'Court 11', 'Pod C (9-11)', 'Doubles', 'Type 2', 'Red', 'Tier 3/4 Doubles', 'Team Alcaraz', array['Abduzzahir Anjarwala', 'Husain Attarwala']::text[], 'Team Federer', array['Najmuddin Valika', 'Fida Husain Abadin']::text[], 90),
    ...
    ('21', '11:50 AM', '11:50', 'Court 5', 'Pod A (3-5)', 'Doubles', 'Type 2', 'Red', 'Tier 3/4 Doubles', 'Team Laver', array['Qasim Hussain', 'Hashim Hussain']::text[], 'Team Federer', array['Najmuddin Valika', 'Fida Husain Abadin']::text[], 210),
    ...
    ('30', '1:30 PM', '13:30', 'Court 5', 'Pod A (3-5)', 'Doubles', 'Type 2', 'Red', 'Tier 3/4 Doubles', 'Team Federer', array['Najmuddin Valika', 'Fida Husain Abadin']::text[], 'Team Djokovic', array['Ammar Lukmanji', 'Hamza Hussain']::text[], 300),
    ...
    ('41', '2:40 PM', '14:40', 'Court 7', 'Pod B (6-8)', 'Singles', 'Type 1', 'Green', 'Tier 3 Singles', 'Team Nadal', array['Mustafa Kanchwala']::text[], 'Team Federer', array['Najmuddin Valika']::text[], 410),
    ...
    ('53', '3:50 PM', '15:50', 'Court 10', 'Pod C (9-11)', 'Singles', 'Type 1', 'Green', 'Tier 3 Singles', 'Team Federer', array['Najmuddin Valika']::text[], 'Team Sampras', array['Adnan Bohri']::text[], 530),
